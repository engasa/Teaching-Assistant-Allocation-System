...
public class HugarianSolver {
	...
	/**
	 * This is the {@link tableForHungarian} table which is a m by m table each entries is a
	 ...
	 * Type. So this cost will be double type; and then it can be used in Hungarian method.
	 * 
	...
	/**
	 * This is {@link Hungarian} Object, used for execute hungarian method
	 */
	private Hungarian hunOpt;
	
	/**
	 * This is an array for storing the result, it is the output of {@link Hungarian}
	 */
	private int[] result;
	...
	/**
	 * This is the size of cap {@link CourseAssistantPool}.
	 */
	int capSize = 0;
	
	/**
	 * This is the size of cip {@link CourseInstancePool}.
	 */
	int cipSize = 0;
